...
// Last-Updated: Tue May 11 13:00:21 2021 (-0400)
//           By: Chenyang Niu
//     Update #: 269
  ...
  for(int i=0; i<Nbin; ++i)
    {
      ...
      if(N == 0)
	{
	  //hcobo[map_pad[i][0]]->Fill(map_pad[i][2]);
	  int j= = map_pad[i][0]*10 + map_pad[i][1];
	  hasad[j] -> Fill(map_pad[i][2]);
	}
    }
